                ...
                <div className="flex-col gap-5 relative sm:p-10 py-10 px-5 shadow-2xl shadow-black-200">
                    ...
                    <div className="flex flex-col gap-5 text-white-600 my-5">
                        ...
                        <div className="flex justify-between items-center">
                            <p className="text-white/80 text-xl font-medium animatedText">{currentProject.company}</p>
                            <p className="text-white/60 text-lg animatedText">{currentProject.date}</p>
                        </div>
                    ...
                    <div className="flex items-center justify-between flex-wrap gap-5">
                        ...
                        <div className="flex justify-end"> {/* This ensures right alignment */}
                            <a
                                className="flex items-center gap-2 cursor-pointer text-white-600"
                                href={currentProject.href ? currentProject.href : "#"}
                                target="_blank"
                                rel="noreferrer"
                            >
